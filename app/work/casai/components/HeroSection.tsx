    ...
    <section className="pt-24 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="relative">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-400 max-w-2xl text-center mb-8">
              A comprehensive mobile solution that revolutionized property management and guest experiences, setting new
              standards in the hospitality industry across Mexico.
            </p>
        ...
        <div className="relative aspect-[16/9] rounded-3xl overflow-hidden">
          <Image
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/20211202_122820.jpg-AFfd9VZ65BbSKM2k4hG1AmZTTKMwhD.jpeg"
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 flex justify-between items-end">
            <div className="space-y-2">
              <h2 className="text-xl font-light">Casai Mobile App</h2>
              <p className="text-sm text-gray-300 max-w-md">
                Revolutionizing property management with seamless digital experiences and efficient operations.
              </p>
            </div>
