      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="relative">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-400 max-w-2xl text-center mb-8">
              Developing Santander Mexico's bank loyalty program website with modern technologies and optimized
              performance, reducing pre-production bugs by 95%.
            </p>
        ...
        <div className="relative aspect-[16/9] rounded-3xl overflow-hidden">
          <Image
            ...
            alt="Santander loyalty program showcase"
            fill
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 flex justify-between items-end">
            <div className="space-y-2">
              <h2 className="text-xl font-light">Loyalty Program Platform</h2>
              <p className="text-sm text-gray-300 max-w-md">
                A modern web platform for managing and redeeming loyalty rewards.
              </p>
            </div>
