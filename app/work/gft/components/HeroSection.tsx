        ...
        <div className="relative">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-400 max-w-2xl text-center mb-8">
              Developing critical systems for Apple device inventory and Sabadell Bank's online banking platform,
              delivering robust solutions for enterprise clients.
            </p>
        ...
        <div className="relative aspect-[16/9] rounded-3xl overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 flex justify-between items-end">
            <div className="space-y-2">
              <h2 className="text-xl font-light">Enterprise Development</h2>
              <p className="text-sm text-gray-300 max-w-md">
                Building robust solutions for inventory management and online banking platforms.
              </p>
            </div>
