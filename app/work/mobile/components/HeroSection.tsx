      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="relative">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-400 max-w-2xl text-center mb-8">
              From nationwide delivery apps to property management solutions, we create powerful mobile experiences that
              transform industries and delight users across Mexico.
            </p>
        ...
        <div className="relative aspect-[16/9] rounded-3xl overflow-hidden">
          <Image
            ...
            alt="Mobile development showcase"
            fill
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 flex justify-between items-end">
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-300 max-w-md">
                Building powerful mobile solutions with Kotlin, Jetpack Compose, and modern Android practices.
              </p>
            </div>
