        ...
        <div className="relative">
          <div className="flex flex-col items-center text-center">
            <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold leading-tight mb-8">
              Brand Excellence Through Innovation
            </h1>
            <p className="text-gray-400 max-w-2xl text-center mb-8">
              From unique visual identities to comprehensive brand strategies, we create powerful brand experiences that
              connect with audiences and elevate businesses in their markets.
            </p>
