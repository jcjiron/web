...
const stats: StatType[] = [
  ...
  },
  {
    ...
    sublabel: "High-Traffic Websites",
  },
  {
    number: "99.9",
          ...
          <div className="relative bg-[hsl(var(--surface-elevation-1))] rounded-3xl p-8 sm:p-12">
            <div className="grid lg:grid-cols-[1fr_400px] gap-12 items-center">
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-tight">
                    Transforming Businesses Through Web Innovation
                  </h2>
                </div>
              ...
              <div className="relative aspect-[4/3] rounded-xl overflow-hidden">
                <Image
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/statistics.jpg-CpFgCRgtW1kfvI9ErAX7k6SAMzCHEz.jpeg"
                  alt="Person making an online purchase with credit card"
                  fill
                  className="object-cover"
                />
              </div>
