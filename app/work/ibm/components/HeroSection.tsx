        ...
        <div className="relative">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-400 max-w-2xl text-center mb-8">
              Developing comprehensive technical support systems for IBM clients, combining web and mobile interfaces
        ...
        <div className="relative aspect-[16/9] rounded-3xl overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 flex justify-between items-end">
            <div className="space-y-2">
              <h2 className="text-xl font-light">Technical Support System</h2>
              <p className="text-sm text-gray-300 max-w-md">
                A comprehensive solution for managing and resolving technical support requests.
              </p>
            </div>
