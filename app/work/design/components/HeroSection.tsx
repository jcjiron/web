        ...
        <div className="relative">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-400 max-w-2xl text-center mb-8">
              From e-commerce platforms to corporate websites, we create engaging digital experiences that transform
              visitor interactions into meaningful conversions and business growth.
            </p>
            <button className="group relative overflow-hidden rounded-full bg-white px-6 py-2 transition-colors hover:bg-gray-100">
              <span className="relative z-10 flex items-center gap-2 text-black">
                Let's Create Together <ArrowRight className="w-4 h-4" />
              </span>
            </button>
          </div>
        </div>
        ...
        <div className="relative aspect-[16/9] rounded-3xl overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 flex justify-between items-end">
            <div className="space-y-2">
              <h2 className="text-xl font-light">Responsive Web Design</h2>
              <p className="text-sm text-gray-300 max-w-md">
                Creating seamless experiences across all devices with modern frameworks and design systems.
              </p>
            </div>
